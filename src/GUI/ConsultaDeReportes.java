...
//Clase que contiene la GUI para consultar los reportes de envío.
...
public class ConsultaDeReportes extends javax.swing.JFrame {

    /**
     * Creates new form ConsultaDeReportes
     */
    ...
    public ConsultaDeReportes(JFrame parent , Persona persona) {
    ...
    private void setDatos(){
        ...
        for(Reporte reporte: ((Empleado)persona).consultarReportes("")){
    ...
    private void setDatos(String key){
        ...
        Object[] datos = new Object[modelo.getColumnCount()];       
        for(Reporte reporte: ((Empleado)persona).consultarReportes(key)){
            
            if(!reporte.getCiudadOrigen().equals(key)){
                continue;
            }
    ...
    private void initComponents() {
        ...
        Lbl_Atras.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(49, 106, 197)));
        ...
        Inpt_Ciudad.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        Inpt_Ciudad.addInputMethodListener(new java.awt.event.InputMethodListener() {
            public void caretPositionChanged(java.awt.event.InputMethodEvent evt) {
            }
            public void inputMethodTextChanged(java.awt.event.InputMethodEvent evt) {
                Inpt_CiudadInputMethodTextChanged(evt);
            }
        });
        ...
        Lbl_Observacion.setText("Ciudad");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(202, 202, 202)
                .addComponent(Inpt_Ciudad, javax.swing.GroupLayout.PREFERRED_SIZE, 187, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addComponent(Lbl_Atras, javax.swing.GroupLayout.PREFERRED_SIZE, 276, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(148, 148, 148))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(Lbl_Consultar)
                    .addComponent(Inpt_Ciudad, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(13, 13, 13)
                .addComponent(Tbl_Tabla, javax.swing.GroupLayout.PREFERRED_SIZE, 136, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void Inpt_CiudadInputMethodTextChanged(java.awt.event.InputMethodEvent evt) {//GEN-FIRST:event_Inpt_CiudadInputMethodTextChanged

        System.out.println("arroz");
    }//GEN-LAST:event_Inpt_CiudadInputMethodTextChanged

    private void Lbl_ConsultarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Lbl_ConsultarMouseClicked

        if(Inpt_Ciudad.getText().equals("")){
            setDatos();
        }
        else{
            setDatos(Inpt_Ciudad.getText());
        }
